...
echo " ---"
/home/eic/bin/telegram_message.sh " starting reference baseline calibration: ${DATESTR} "
...
echo " ---"
/home/eic/bin/telegram_message.sh " reference baseline calibration completed: ${DATESTR} "
