...
0 	 0x0		 0xb01b         ${BCRCONF}	maxthreshold
1	 0xf		 0xb01b 	${BCRCONF}	maxthreshold
...
# chip	 laneMask=0/0xF	 eccr		conf/bcr	conf/pcr
0 	 0x0		 0xb01b 	${BCRCONF}	testpulse
1	 0xf		 0xb01b         ${BCRCONF}	dcr-setup/${DATESTR}/PCR/chip1.range${RANGE[1]}
2  	 0x0		 0xb01b 	${BCRCONF}	maxthreshold
3  	 0x0		 0xb01b 	${BCRCONF}	maxthreshold
4  	 0x0		 0xb01b 	${BCRCONF}	maxthreshold
5  	 0x0		 0xb01b 	${BCRCONF}	maxthreshold
...
# chip	 laneMask=0/0xF	 eccr		conf/bcr	conf/pcr
0 	 0x1		 0xb01b 	${BCRCONF}	testpulse
1	 0xf		 0xb01b         ${BCRCONF}	dcr-setup/${DATESTR}/PCR/chip1.range${RANGE[1]}.current
2  	 0x0		 0xb01b 	${BCRCONF}	maxthreshold
3  	 0x0		 0xb01b 	${BCRCONF}	maxthreshold
4  	 0x0		 0xb01b 	${BCRCONF}	maxthreshold
5  	 0x0		 0xb01b 	${BCRCONF}	maxthreshold
