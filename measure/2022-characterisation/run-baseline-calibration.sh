...
0 	 0xf 		 0xb01b 	minus40c	maxthreshold
1	 0xf 		 0xb01b 	minus40c	maxthreshold
2  	 0x0 		 0xb01b 	minus40c	maxthreshold
3  	 0x0		 0xb01b 	minus40c	maxthreshold
...
# chip	 laneMask=0/0xF	 eccr		conf/bcr	conf/pcr
0 	 0xf 		 0xb01b 	minus40c	dcr-setup/${DATESTR}/PCR/chip0.range1
1	 0xf 		 0xb01b 	minus40c	dcr-setup/${DATESTR}/PCR/chip1.range1
2  	 0x0 		 0xb01b 	minus40c	dcr-setup/${DATESTR}/PCR/chip2.range1
3  	 0x0		 0xb01b 	minus40c	dcr-setup/${DATESTR}/PCR/chip3.range1
4  	 0x0 		 0xb01b 	plus20c		maxthreshold
5  	 0x0 		 0xb01b 	plus20c		maxthreshold
# don't delete this line
EOF
