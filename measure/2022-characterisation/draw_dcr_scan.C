void draw_map(const char *dirname, int chip, float vmin = 22., float vmax = 34.);

void
draw_dcr_scan(const char *dirname, int chip, float vmin, float vmax)
{
  draw_map(dirname, chip, vmin, vmax);
}

void
draw_map(const char *dirname, int chip, float vmin, float vmax)
{
