...
Firmware for Alcor-Firefly board
	...
	firmware revisions:
		...
		- top_20Sept2021.bit:	
				-- data filter implemented: command 0x33 in alcor_controller, tx_buffer_filter_proc in alcor_tx_word_buffer.vhd
				-- improved the process tx_buffer_fifo_write_proc in alcor_tx_word_buffer.vhd
		...
		- top_24Oct2021_Eth_Xil.bit:
				--same as previous version, but with Xilinx Ethernet core
		- top_24Oct2021_Slow_Eth_Xil.bit:
				-- in alcor dataout, switching back to Standard FIFO and old readout process (as in top_20Sept2021.bit)